<h1>The Perceptron Unit for Multiple Linear Regression</h1>
<p align="justify">
...
<p align="justify">
    ...
    The minimum of the function is apparent. This is where the absolute value of the gradient of the 
...
<p align="justify"> 
    ...
    If <i>ω<sub>i</sub></i> is too small, the same derivative will be negative, and <i>ω<sub>i</sub></i> is increased after the increment.
    The magnitude of the derivative, and therefore the increment, is proportional to how far off <i>ω<sub>i</sub></i> is from the optimal value.
...
<p align="justify">
    ...
    Dividing the learning rate by the second derivative reduces the potential for overshooting.
...
<p align="justify">
    ...
    after an optimal value for <i>r</i> is found.
    However, mileage may vary. 
    Refer to additional learning optimization methods if a sufficiently small value for <i>h</i> cannot be achieved.
</p>
<hr>
<p align="center">
...
<p align="justify">
    Plotting concentration data over time shows an approximately exponential trend (which might imply a first order rate reaction).
...
<p align="justify">
    ...
    Although this led to a relatively small R squared value, 
    ...
    You may investigate this plot more thoroughly by running "plot.py."
</p>
